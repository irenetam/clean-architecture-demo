...
{
    public class GetEventsExportQueryHandler : IRequestHandler<GetEventsExportQuery, EventExportFileVieModel>
    {
        ...
        public async Task<EventExportFileVieModel> Handle(GetEventsExportQuery request, CancellationToken cancellationToken)
        {
            ...
            var eventExportFileDto = new EventExportFileVieModel() { ContentType = "text/csv", Data = fileData, EventExportFileName = $"{Guid.NewGuid()}.csv" };
